...
#define EXP_SPIKE(n)(200000 / (1 + pow(2,(-n + 33))) + (2 * CUBE(n) / 3) + (40 * SQUARE(n) / 3))
...
#define EXP_UPDATE(n)                                       \
    ...
    :(n <= 29) ? ((300 * n) + 2000)                         \
    :(n <= 30) ? ((16300 * n) - 462000)                     \
    :(n <= 39) ? (((6400 * n) / 9) + (17000 / 3))           \
    :(n <= 40) ? ((30600 * n) - 1160000)                    \
    :(n <= 49) ? (((12500 * n) / 9) + (76000 / 9))          \
    :(n <= 50) ? ((48500 * n) - 2300000)                    \
    :(n <= 59) ? ((2400 * n) + 5000)                        \
    :(n <= 60) ? ((69400 * n) - 3948000)                    \
    :(n <= 69) ? (((34300 * n) / 9) - (38000 / 3))          \
    :(n <= 70) ? ((92700 * n) - 6146000)                    \
    :(n <= 79) ? (((51200 * n) / 9) - (497000 / 9))         \
    :(n <= 80) ? ((117800 * n) - 8912000)                   \
    :(n <= 89) ? ((8100 * n) - 136000)                      \
    :(n <= 90) ? ((144100 * n) - 12240000)                  \
    :(n <= 99) ? (((100000 * n) / 9) - 271000)              \
    :            ((171000 * n) - 16100000)
